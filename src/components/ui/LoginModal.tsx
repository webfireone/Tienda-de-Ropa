...
import { X, Mail, Lock, Eye, EyeOff, Loader2, User, ArrowLeft, CheckCircle2, Send } from "lucide-react"
        ...
        {mode === "reset" ? (
          <>
            <div className="flex items-center gap-2 mb-1">
              <button type="button" onClick={resetView} className="text-muted-foreground hover:text-foreground transition-colors">
                <ArrowLeft className="h-4 w-4" />
              </button>
              <h2 className="text-lg font-display font-semibold">Restablecer Contraseña</h2>
            </div>
            <p className="text-xs text-muted-foreground mb-5">Te enviamos un link a tu correo</p>
            ...
            {resetSent ? (
              <div className="p-4 rounded-xl bg-emerald-900/30 border border-emerald-800 text-sm text-emerald-300 space-y-3">
                ...
                <Button type="button" variant="outline" size="sm" onClick={resetView} className="text-xs">
          ...
          <>
            <h2 className="text-lg font-display font-semibold mb-1">{mode === "register" ? "Crear Cuenta" : "Iniciar Sesión"}</h2>
            <p className="text-xs text-muted-foreground mb-5">{mode === "register" ? "Registrate para comprar" : "Ingresá para agregar al carrito"}</p>
