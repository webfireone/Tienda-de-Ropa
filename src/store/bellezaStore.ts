...
const CURATED_LOOKS: CuratedLook[] = [
  // MINIMALISTA
  { id: "min-01", name: "Blanco Puro", category: "minimalista", config: { colors: { primary: "#000000", highlight: "#666666", background: "#ffffff", foreground: "#0a0a0a", card: "#fafafa", muted: "#f5f5f5", border: "#e5e5e5", secondary: "#f5f5f5", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#000000", accent: "#888888", accentForeground: "#ffffff", mutedForeground: "#999999", cardForeground: "#0a0a0a", input: "#f5f5f5", ring: "#000000" }, background: "solid-white-min", backgroundGradient: "#ffffff", backgroundColor: "#ffffff", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.5, blurIntensity: 0.5 }, hover: { liftDistance: "2px", glowColor: "#000000", glowIntensity: 0.05, transitionDuration: "0.2s" }, mode: "light" } },
  { id: "min-02", name: "Negro Profundo", category: "minimalista", config: { colors: { primary: "#ffffff", highlight: "#a0a0a0", background: "#000000", foreground: "#f5f5f5", card: "#0a0a0a", muted: "#141414", border: "#1f1f1f", secondary: "#0a0a0a", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#000000", secondaryForeground: "#ffffff", accent: "#666666", accentForeground: "#ffffff", mutedForeground: "#888888", cardForeground: "#f5f5f5", input: "#141414", ring: "#ffffff" }, background: "solid-dark", backgroundGradient: "#000000", backgroundColor: "#000000", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.5, blurIntensity: 0.5 }, hover: { liftDistance: "2px", glowColor: "#ffffff", glowIntensity: 0.05, transitionDuration: "0.2s" }, mode: "dark" } },
  { id: "min-03", name: "Gris Lunar", category: "minimalista", config: { colors: { primary: "#374151", highlight: "#6b7280", background: "#f9fafb", foreground: "#111827", card: "#ffffff", muted: "#f3f4f6", border: "#e5e7eb", secondary: "#f3f4f6", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#374151", accent: "#4b5563", accentForeground: "#ffffff", mutedForeground: "#6b7280", cardForeground: "#111827", input: "#f3f4f6", ring: "#374151" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #f9fafb, #f3f4f6, #f9fafb)", backgroundColor: "#f9fafb", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Cormorant Garamond", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.2, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.25rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.3, blurIntensity: 0.3 }, hover: { liftDistance: "1px", glowColor: "#374151", glowIntensity: 0.03, transitionDuration: "0.2s" }, mode: "light" } },
  { id: "min-04", name: "Beige Arena", category: "minimalista", config: { colors: { primary: "#78716c", highlight: "#a8a29e", background: "#fafaf9", foreground: "#292524", card: "#ffffff", muted: "#f5f5f4", border: "#e7e5e4", secondary: "#f5f5f4", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#78716c", accent: "#57534e", accentForeground: "#ffffff", mutedForeground: "#78716c", cardForeground: "#292524", input: "#f5f5f4", ring: "#78716c" }, background: "gradient-cream", backgroundGradient: "linear-gradient(135deg, #fafaf9, #f5f5f4, #fafaf9)", backgroundColor: "#fafaf9", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Cormorant Garamond", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "500", bodyWeight: "400", baseSize: 16, scaleRatio: 1.2, letterSpacing: "0em", lineHeight: "1.7" }, layout: { borderRadius: "0.25rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.3, blurIntensity: 0.3 }, hover: { liftDistance: "1px", glowColor: "#78716c", glowIntensity: 0.03, transitionDuration: "0.2s" }, mode: "light" } },

  // PASTEL
  { id: "pas-01", name: "Rosa Cotton", category: "pastel", config: { colors: { primary: "#f472b6", highlight: "#f9a8d4", background: "#fdf2f8", foreground: "#831843", card: "#ffffff", muted: "#fce7f3", border: "#fbcfe8", secondary: "#fce7f3", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#f472b6", accent: "#ec4899", accentForeground: "#ffffff", mutedForeground: "#f472b6", cardForeground: "#831843", input: "#fce7f3", ring: "#f472b6" }, background: "gradient-lavender", backgroundGradient: "linear-gradient(135deg, #fdf2f8, #fce7f3, #fdf2f8)", backgroundColor: "#fdf2f8", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#f472b6", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },
  { id: "pas-02", name: "Lavanda Suave", category: "pastel", config: { colors: { primary: "#8b5cf6", highlight: "#c4b5fd", background: "#faf5ff", foreground: "#3b0764", card: "#ffffff", muted: "#f3e8ff", border: "#e9d5ff", secondary: "#f3e8ff", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#8b5cf6", accent: "#a78bfa", accentForeground: "#ffffff", mutedForeground: "#8b5cf6", cardForeground: "#3b0764", input: "#f3e8ff", ring: "#8b5cf6" }, background: "gradient-lavender", backgroundGradient: "linear-gradient(135deg, #faf5ff, #f3e8ff, #faf5ff)", backgroundColor: "#faf5ff", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#8b5cf6", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },
  { id: "pas-03", name: "Menta Natural", category: "pastel", config: { colors: { primary: "#10b981", highlight: "#6ee7b7", background: "#ecfdf5", foreground: "#064e3b", card: "#ffffff", muted: "#d1fae5", border: "#a7f3d0", secondary: "#d1fae5", success: "#10b981", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#10b981", accent: "#059669", accentForeground: "#ffffff", mutedForeground: "#10b981", cardForeground: "#064e3b", input: "#d1fae5", ring: "#10b981" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #ecfdf5, #d1fae5, #ecfdf5)", backgroundColor: "#ecfdf5", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#10b981", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },
  { id: "pas-04", name: "Melocotón", category: "pastel", config: { colors: { primary: "#fb923c", highlight: "#fdba74", background: "#fff7ed", foreground: "#431407", card: "#ffffff", muted: "#ffedd5", border: "#fed7aa", secondary: "#ffedd5", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#fb923c", accent: "#f97316", accentForeground: "#ffffff", mutedForeground: "#fb923c", cardForeground: "#431407", input: "#ffedd5", ring: "#fb923c" }, background: "gradient-peach", backgroundGradient: "linear-gradient(135deg, #fff7ed, #ffedd5, #fff7ed)", backgroundColor: "#fff7ed", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#fb923c", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },
  { id: "pas-05", name: "Cielo Claro", category: "pastel", config: { colors: { primary: "#0ea5e9", highlight: "#7dd3fc", background: "#f0f9ff", foreground: "#0c4a6e", card: "#ffffff", muted: "#e0f2fe", border: "#bae6fd", secondary: "#e0f2fe", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#0ea5e9", accent: "#0284c7", accentForeground: "#ffffff", mutedForeground: "#0ea5e9", cardForeground: "#0c4a6e", input: "#e0f2fe", ring: "#0ea5e9" }, background: "gradient-sky-light", backgroundGradient: "linear-gradient(135deg, #f0f9ff, #e0f2fe, #f0f9ff)", backgroundColor: "#f0f9ff", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#0ea5e9", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },
  { id: "pas-06", name: "Amarillo Sol", category: "pastel", config: { colors: { primary: "#ca8a04", highlight: "#fde047", background: "#fefce8", foreground: "#422006", card: "#ffffff", muted: "#fef9c3", border: "#fef08a", secondary: "#fef9c3", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#ca8a04", accent: "#a16207", accentForeground: "#ffffff", mutedForeground: "#ca8a04", cardForeground: "#422006", input: "#fef9c3", ring: "#ca8a04" }, background: "gradient-cream", backgroundGradient: "linear-gradient(135deg, #fefce8, #fef9c3, #fefce8)", backgroundColor: "#fefce8", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#ca8a04", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "light" } },

  // MODERNO
  { id: "mod-01", name: "Violeta Neón", category: "moderno", config: { colors: { primary: "#7c3aed", highlight: "#ec4899", background: "#0a0014", foreground: "#f5f3ff", card: "#0f001a", muted: "#150020", border: "#200030", secondary: "#0f001a", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#7c3aed", accent: "#6d28d9", accentForeground: "#ffffff", mutedForeground: "#9060c0", cardForeground: "#f5f3ff", input: "#150020", ring: "#7c3aed" }, background: "gradient-purple", backgroundGradient: "linear-gradient(135deg, #0a0014, #150020, #0a0014)", backgroundColor: "#0a0014", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Space Grotesk", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#7c3aed", glowIntensity: 0.25, transitionDuration: "0.2s" }, mode: "dark" } },
  { id: "mod-02", name: "Cyan Eléctrico", category: "moderno", config: { colors: { primary: "#06b6d4", highlight: "#22d3ee", background: "#030712", foreground: "#f0f9ff", card: "#0a1525", muted: "#0f1f35", border: "#1a3050", secondary: "#0a1525", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#030712", secondaryForeground: "#06b6d4", accent: "#0891b2", accentForeground: "#ffffff", mutedForeground: "#60c0e0", cardForeground: "#f0f9ff", input: "#0f1f35", ring: "#06b6d4" }, background: "gradient-ocean", backgroundGradient: "linear-gradient(135deg, #030712, #0a1525, #030712)", backgroundColor: "#030712", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Space Grotesk", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#06b6d4", glowIntensity: 0.25, transitionDuration: "0.2s" }, mode: "dark" } },
  { id: "mod-03", name: "Rosa Fuchsia", category: "moderno", config: { colors: { primary: "#d946ef", highlight: "#f472b6", background: "#0a0010", foreground: "#fdf2f8", card: "#0f0015", muted: "#15001a", border: "#1a0020", secondary: "#0f0015", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#d946ef", accent: "#c026d3", accentForeground: "#ffffff", mutedForeground: "#b060c0", cardForeground: "#fdf2f8", input: "#15001a", ring: "#d946ef" }, background: "gradient-purple", backgroundGradient: "linear-gradient(135deg, #0a0010, #15001a, #0a0010)", backgroundColor: "#0a0010", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Space Grotesk", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#d946ef", glowIntensity: 0.25, transitionDuration: "0.2s" }, mode: "dark" } },
  ...
  { id: "mod-05", name: "Naranja Atardecer", category: "moderno", config: { colors: { primary: "#f97316", highlight: "#fbbf24", background: "#1a0500", foreground: "#fff7ed", card: "#200a00", muted: "#2a0f00", border: "#3a1800", secondary: "#200a00", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#f97316", accent: "#ea580c", accentForeground: "#ffffff", mutedForeground: "#c08050", cardForeground: "#fff7ed", input: "#2a0f00", ring: "#f97316" }, background: "gradient-sunset", backgroundGradient: "linear-gradient(135deg, #1a0500, #2a1000, #1a0500)", backgroundColor: "#1a0500", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Space Grotesk", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#f97316", glowIntensity: 0.25, transitionDuration: "0.2s" }, mode: "dark" } },
  { id: "mod-06", name: "Azul Cobalto", category: "moderno", config: { colors: { primary: "#2563eb", highlight: "#60a5fa", background: "#030510", foreground: "#eff6ff", card: "#060a18", muted: "#0a0f20", border: "#101530", secondary: "#060a18", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#2563eb", accent: "#1d4ed8", accentForeground: "#ffffff", mutedForeground: "#6080c0", cardForeground: "#eff6ff", input: "#0a0f20", ring: "#2563eb" }, background: "gradient-sky", backgroundGradient: "linear-gradient(135deg, #030510, #060a18, #030510)", backgroundColor: "#030510", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Space Grotesk", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#2563eb", glowIntensity: 0.25, transitionDuration: "0.2s" }, mode: "dark" } },

  // EJECUTIVO
  { id: "eje-01", name: "Azul Marina", category: "ejecutivo", config: { colors: { primary: "#1e40af", highlight: "#60a5fa", background: "#f8fafc", foreground: "#0f172a", card: "#ffffff", muted: "#f1f5f9", border: "#e2e8f0", secondary: "#f1f5f9", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#1e40af", accent: "#3b82f6", accentForeground: "#ffffff", mutedForeground: "#475569", cardForeground: "#0f172a", input: "#f1f5f9", ring: "#1e40af" }, background: "gradient-sky-light", backgroundGradient: "linear-gradient(135deg, #f8fafc, #e2e8f0, #f8fafc)", backgroundColor: "#f8fafc", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: true, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Montserrat", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "3px", glowColor: "#1e40af", glowIntensity: 0.1, transitionDuration: "0.2s" }, mode: "light" } },
  ...
  { id: "eje-04", name: "Oro Negro", category: "ejecutivo", config: { colors: { primary: "#d4af37", highlight: "#fbbf24", background: "#050a14", foreground: "#f0ead6", card: "#0a1018", muted: "#0f1520", border: "#1a2030", secondary: "#0a1018", success: "#10b981", warning: "#d4af37", destructive: "#ef4444", primaryForeground: "#050a14", secondaryForeground: "#d4af37", accent: "#b8860b", accentForeground: "#f0ead6", mutedForeground: "#6070a0", cardForeground: "#f0ead6", input: "#0f1520", ring: "#d4af37" }, background: "solid-dark", backgroundGradient: "#050a14", backgroundColor: "#050a14", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#d4af37", glowIntensity: 0.2, transitionDuration: "0.3s" }, mode: "dark" } },
  { id: "eje-05", name: "Burdeos Clásico", category: "ejecutivo", config: { colors: { primary: "#881337", highlight: "#fb7185", background: "#fafaf9", foreground: "#1c1917", card: "#ffffff", muted: "#f5f5f4", border: "#e7e5e4", secondary: "#f5f5f4", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#881337", accent: "#9f1239", accentForeground: "#ffffff", mutedForeground: "#881337", cardForeground: "#1c1917", input: "#f5f5f4", ring: "#881337" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #fafaf9, #f5f5f4, #fafaf9)", backgroundColor: "#fafaf9", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: true, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "3px", glowColor: "#881337", glowIntensity: 0.1, transitionDuration: "0.2s" }, mode: "light" } },
  { id: "eje-06", name: "Verde Inglés", category: "ejecutivo", config: { colors: { primary: "#166534", highlight: "#4ade80", background: "#f0fdf4", foreground: "#14532d", card: "#ffffff", muted: "#dcfce7", border: "#bbf7d0", secondary: "#dcfce7", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#166534", accent: "#15803d", accentForeground: "#ffffff", mutedForeground: "#166534", cardForeground: "#14532d", input: "#dcfce7", ring: "#166534" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #f0fdf4, #dcfce7, #f0fdf4)", backgroundColor: "#f0fdf4", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: true, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "3px", glowColor: "#166534", glowIntensity: 0.1, transitionDuration: "0.2s" }, mode: "light" } },

  // NOCTURNO
  { id: "noc-01", name: "Medianoche", category: "nocturno", config: { colors: { primary: "#1e3a8a", highlight: "#93c5fd", background: "#030411", foreground: "#f0f4ff", card: "#0a1525", muted: "#0f1f35", border: "#1a2f50", secondary: "#0a1525", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#1e3a8a", accent: "#1d4ed8", accentForeground: "#ffffff", mutedForeground: "#6080c0", cardForeground: "#f0f4ff", input: "#0f1f35", ring: "#1e3a8a" }, background: "gradient-sky", backgroundGradient: "linear-gradient(135deg, #030411, #0a1525, #030411)", backgroundColor: "#030411", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#1e3a8a", glowIntensity: 0.2, transitionDuration: "0.3s" }, mode: "dark" } },
  { id: "noc-02", name: "Púrpura Oscuro", category: "nocturno", config: { colors: { primary: "#6d28d9", highlight: "#c4b5fd", background: "#0a0010", foreground: "#f5f3ff", card: "#0f0018", muted: "#150020", border: "#1a0030", secondary: "#0f0018", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#6d28d9", accent: "#5b21b6", accentForeground: "#ffffff", mutedForeground: "#9080b0", cardForeground: "#f5f3ff", input: "#150020", ring: "#6d28d9" }, background: "gradient-purple", backgroundGradient: "linear-gradient(135deg, #0a0010, #0f0018, #0a0010)", backgroundColor: "#0a0010", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#6d28d9", glowIntensity: 0.2, transitionDuration: "0.3s" }, mode: "dark" } },
  ...
  // GLAMOUR (marca)
  { id: "gla-01", name: "GLAMOURS Violeta", category: "glamour", config: { colors: { primary: "#7c5cfc", highlight: "#ec4899", background: "#0d0d1a", foreground: "#e8e8f0", card: "#161627", muted: "#1a1a30", border: "#1e1e3a", secondary: "#1f1f3a", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#c4b5fd", accent: "#2d1b69", accentForeground: "#e17055", mutedForeground: "#8888a8", cardForeground: "#e8e8f0", input: "#1e1e3a", ring: "#7c5cfc" }, background: "gradient-dark", backgroundGradient: "linear-gradient(135deg, #0d0d1a, #1a0a2e, #161627)", backgroundColor: "#0d0d1a", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#7c5cfc", glowIntensity: 0.15, transitionDuration: "0.3s" }, mode: "dark" } },

  // MINIMALISTA (nuevos)
  { id: "min-05", name: "Cemento", category: "minimalista", config: { colors: { primary: "#52525b", highlight: "#a1a1aa", background: "#f4f4f5", foreground: "#18181b", card: "#ffffff", muted: "#e4e4e7", border: "#d4d4d8", secondary: "#e4e4e7", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#52525b", accent: "#71717a", accentForeground: "#ffffff", mutedForeground: "#71717a", cardForeground: "#18181b", input: "#e4e4e7", ring: "#52525b" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #f4f4f5, #e4e4e7, #f4f4f5)", backgroundColor: "#f4f4f5", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: false, grain: false, noise: false }, typography: { fontDisplay: "Cormorant Garamond", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.2, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.125rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.2, blurIntensity: 0.2 }, hover: { liftDistance: "1px", glowColor: "#52525b", glowIntensity: 0.02, transitionDuration: "0.2s" }, mode: "light" } },
  { id: "min-06", name: "Onix", category: "minimalista", config: { colors: { primary: "#e4e4e7", highlight: "#a1a1aa", background: "#09090b", foreground: "#f4f4f5", card: "#18181b", muted: "#27272a", border: "#3f3f46", secondary: "#18181b", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#09090b", secondaryForeground: "#e4e4e7", accent: "#71717a", accentForeground: "#ffffff", mutedForeground: "#71717a", cardForeground: "#f4f4f5", input: "#27272a", ring: "#e4e4e7" }, background: "solid-dark", backgroundGradient: "#09090b", backgroundColor: "#09090b", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: false, glass: false, grain: false, noise: false }, typography: { fontDisplay: "Cormorant Garamond", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.2, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.125rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.2, blurIntensity: 0.2 }, hover: { liftDistance: "1px", glowColor: "#e4e4e7", glowIntensity: 0.02, transitionDuration: "0.2s" }, mode: "dark" } },

  // PASTEL (nuevos)
  { id: "pas-07", name: "Lila Profundo", category: "pastel", config: { colors: { primary: "#a78bfa", highlight: "#ddd6fe", background: "#f5f3ff", foreground: "#2e1065", card: "#ffffff", muted: "#ede9fe", border: "#ddd6fe", secondary: "#ede9fe", success: "#22c55e", warning: "#fbbf24", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#a78bfa", accent: "#8b5cf6", accentForeground: "#ffffff", mutedForeground: "#a78bfa", cardForeground: "#2e1065", input: "#ede9fe", ring: "#a78bfa" }, background: "gradient-lavender", backgroundGradient: "linear-gradient(135deg, #f5f3ff, #ede9fe, #f5f3ff)", backgroundColor: "#f5f3ff", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: true, grid: false, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Poppins", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "4px", glowColor: "#a78bfa", glowIntensity: 0.12, transitionDuration: "0.3s" }, mode: "light" } },
  ...
  { id: "eje-08", name: "Granate Noble", category: "ejecutivo", config: { colors: { primary: "#7f1d1d", highlight: "#fca5a5", background: "#fafaf9", foreground: "#1c1917", card: "#ffffff", muted: "#f5f5f4", border: "#e7e5e4", secondary: "#f5f5f4", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#7f1d1d", accent: "#991b1b", accentForeground: "#ffffff", mutedForeground: "#7f1d1d", cardForeground: "#1c1917", input: "#f5f5f4", ring: "#7f1d1d" }, background: "gradient-snow", backgroundGradient: "linear-gradient(135deg, #fafaf9, #f5f5f4, #fafaf9)", backgroundColor: "#fafaf9", backgroundPattern: "", backgroundImage: "", effects: { particles: false, orbs: false, grid: true, glass: true, grain: false, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "600", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.6" }, layout: { borderRadius: "0.5rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 0.8, blurIntensity: 0.8 }, hover: { liftDistance: "3px", glowColor: "#7f1d1d", glowIntensity: 0.1, transitionDuration: "0.2s" }, mode: "light" } },

  // NOCTURNO (nuevos)
  { id: "noc-05", name: "Esmeralda Nocturna", category: "nocturno", config: { colors: { primary: "#059669", highlight: "#34d399", background: "#030a05", foreground: "#dcfce7", card: "#050f05", muted: "#081408", border: "#0a1a0a", secondary: "#050f05", success: "#22c55e", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#059669", accent: "#047857", accentForeground: "#ffffff", mutedForeground: "#50a050", cardForeground: "#dcfce7", input: "#081408", ring: "#059669" }, background: "gradient-forest", backgroundGradient: "linear-gradient(135deg, #030a05, #050f05, #030a05)", backgroundColor: "#030a05", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#059669", glowIntensity: 0.2, transitionDuration: "0.3s" }, mode: "dark" } },
  { id: "noc-06", name: "Coral profundo", category: "nocturno", config: { colors: { primary: "#f43f5e", highlight: "#fda4af", background: "#0a0005", foreground: "#fff1f2", card: "#0f0008", muted: "#140008", border: "#1a0010", secondary: "#0f0008", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#ffffff", secondaryForeground: "#f43f5e", accent: "#e11d48", accentForeground: "#ffffff", mutedForeground: "#c06070", cardForeground: "#fff1f2", input: "#140008", ring: "#f43f5e" }, background: "gradient-rose", backgroundGradient: "linear-gradient(135deg, #0a0005, #1a0008, #0a0005)", backgroundColor: "#0a0005", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#f43f5e", glowIntensity: 0.25, transitionDuration: "0.3s" }, mode: "dark" } },
  ...
  { id: "gla-04", name: "Cristal Violeta", category: "glamour", config: { colors: { primary: "#a78bfa", highlight: "#fbbf24", background: "#0d0d1a", foreground: "#e8e8f0", card: "#161627", muted: "#1a1a30", border: "#1e1e3a", secondary: "#1f1f3a", success: "#10b981", warning: "#f59e0b", destructive: "#ef4444", primaryForeground: "#0d0d1a", secondaryForeground: "#a78bfa", accent: "#8b5cf6", accentForeground: "#ffffff", mutedForeground: "#8888a8", cardForeground: "#e8e8f0", input: "#1e1e3a", ring: "#a78bfa" }, background: "gradient-dark", backgroundGradient: "linear-gradient(135deg, #0d0d1a, #1a0a2e, #161627)", backgroundColor: "#0d0d1a", backgroundPattern: "", backgroundImage: "", effects: { particles: true, orbs: true, grid: true, glass: true, grain: true, noise: false }, typography: { fontDisplay: "Playfair Display", fontBody: "Inter", fontMono: "JetBrains Mono", headingWeight: "700", bodyWeight: "400", baseSize: 16, scaleRatio: 1.25, letterSpacing: "0em", lineHeight: "1.5" }, layout: { borderRadius: "1rem", containerWidth: "80rem", spacingUnit: 4, shadowIntensity: 1, blurIntensity: 1 }, hover: { liftDistance: "4px", glowColor: "#a78bfa", glowIntensity: 0.2, transitionDuration: "0.3s" }, mode: "dark" } },
]
